 ...
 */
import { buildInviteMessage, calculateMiningRates, diffDaysUtc, formatNumber, generateReferralCode, getISTDate, getReferralCounts, tickHmsCountdown } from '@/app/(tabs)/Home/home.helpers';
    ...
    if (powerOn) {
      timer = setInterval(() => {
        ...
        setTimeLeft(prev => {
          ...
          if (finished) setPowerOn(false); // Stop mining when time is up
          return next;
        });
